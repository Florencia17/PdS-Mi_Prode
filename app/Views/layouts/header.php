...
<div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
        <div class="nano">
            <div class="nano-content">
                <ul>
                    <div class="logo"><a href="home/index">
                          <img src="assets/images/logo.png" alt="" /><span>Mi Prode</span></a></div>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i> Equipos <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="<?=base_url();?>/form-alta-equipo">Alta</a></li>
                            <li><a href="<?=base_url();?>/listado-equipos">Listado</a></li>
                        </ul>
                    </li>
